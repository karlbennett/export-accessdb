...
public class VolunteerCommitmentTypeLookups implements CSVable {
    ...
    public VolunteerCommitmentTypeLookups() {
    }

    public VolunteerCommitmentTypeLookups(String record) {
        init(record);
    }
