...
public class VolunteerTypeOfActivityLookups implements CSVable {
    ...
    public VolunteerTypeOfActivityLookups() {
    }

    public VolunteerTypeOfActivityLookups(String record) {
        init(record);
    }
