...
public class VolunteerContactInfo implements CSVable {
    ...
    public VolunteerContactInfo(String record) {
        init(record);
    }
    ...
    public void init(String record) {
        ...
        this.isdefault = fields[9].replace(String.valueOf(this.enclosure), "").equals("1");
    ...
    public List<String[]> getColumnNames() {
        if (this.columnNames == null) {
            ...
            this.columnNames.add(new String[]{"IsDefault", "Boolean"});
        }
