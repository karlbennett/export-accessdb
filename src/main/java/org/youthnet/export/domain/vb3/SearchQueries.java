...
public class SearchQueries implements CSVable {
    ...
    public void init(String record) {
        ...
        try {
            this.lastupdated = new Timestamp(simpleDateFormat.parse(fields[0].replace(String.valueOf(this.enclosure), "")).getTime());
        ...
        this.data = fields[9].replace(String.valueOf(this.enclosure), "").getBytes();
