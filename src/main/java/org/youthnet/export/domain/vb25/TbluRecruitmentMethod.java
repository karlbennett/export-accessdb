...
public class TbluRecruitmentMethod implements CSVable {
    ...
    public void init(String record) {
        ...
        this.recruitmentmethod = fields[0].replace(String.valueOf(this.enclosure), "");
